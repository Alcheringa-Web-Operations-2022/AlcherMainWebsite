...
const sectionTitles = ['MARKETING','PR & BRANDING','EVENTS','CREATIVES','IITG MUN','WEB - OPS', 'APP - OPS', 'CONVENER', 'FINANCE'];
const teamsImages = [
    //MARKETING
    [
        {
                        ...
                        <section className="teams__images" key={i} ref={(el) => (teamsImagesRef.current[i] = el)}>
                            <div>
                                {el
                                    .filter((el, i) => i % 2 == 0)
                                    .map((el, i) => {
                                        return <figure className="snip1527">
                                        <div className="snip1527image"><img src={el.dp} alt="pr-sample23" /></div>
                                        <figcaption>
                                         
                                          <div><h3>{el.name}</h3><h3>Executive</h3></div>
                                          <div>
                                            <p>
                                            {el.phone}<br/>{el.email}
                                            </p>
                                            <p>
